...
@section('content')
<div class="content">
    <form action="{{ route('service.update', $edit->id) }}" method="post"  enctype="multipart/form-data" class="form-horizontal"> 
        @csrf 
        <div class="row">  
            <div class="col-lg-6">
                <div class="card">
                    ...
                    <div class="card-body card-block"> 
                        <div class="form-group">
                            ...
                            <input type="number" required id="basic_price"  value="{{ $edit->basic_price }}" name="basic_price" class="form-control" > 
                        ...
                        <div class="form-group">
                           ...
                           <img src="{{ asset('storage'. $edit->image) }}" width="150" class="mt-2" alt="service-image">
                            @if($errors->has('image'))
                        ...
                        <div class="form-group pb-3">
                            ...
                            <div class="feature">
                                @php
                                    $features = json_decode($edit->datas); 
                                @endphp 
                                <div class="list-group">
                                   @foreach($features as $key =>  $datas)
                                        @foreach($datas as $key => $data) 
                                           <div class="list-group-item d-flex align-items-center">
                                                <div class="px-1"><input type="text" value="{{ $key  }}" name="key[]" placeholder="Feature title" class="form-control"></div>
                                                <div class="px-1"><input type="text" value="{{  $data }}" name="value[]"  placeholder="Feature details"  class="form-control"></div>
            ...
            <div class="col-lg-6">
                    ...
                    <div class="card-body card-block">   
                        <div class="form-group pb-3">
                            ...
                            <div class="service-include">
                                <div class="list-group"> 
                                   @foreach($edit->serviceInclude as  $data) 
                                    <div class="list-group-item d-flex align-items-center">
                                        <input type="hidden" name="include_ids[]" value="{{ $data->id }}">
                                       <div class="pr-2" style="flex: 1">
                                            <div class="py-1">
                                                <input type="text" value="{{ $data->title }}" required name="include_title[]" placeholder="Enter title" class="form-control">
                                            </div>
                                            <div class="py-1">
                                                <textarea name="description[]"  id="" cols="30" rows="2" class="form-control" placeholder="Enter short details">{{ $data->description }}</textarea>
                                            </div>
                                            <div class="py-1">
                                                <input type="number" required name="price[]"  placeholder="Enter price"  class="form-control" value="{{ $data->price }}">
                                            </div>
                                       </div>
                                        <div class="feature__trash bg-danger text-white p-2"><i class="fa fa-trash"></i></div>
                                    </div> 
                ...
                <div class="card">
                    ...
                    <div class="card-body card-block">   
                        <div class="form-group pb-3">
                            <div class="d-flex justify-content-between pb-2">
                            <label for="image" class=" form-control-label">Service material cost <span class="text-danger">(optional)</span></label>
                            <button type="button" class="btn btn-sm btn-success add-new-cost"><i class="fa fa-plus"></i></button>
                            </div>
                            <div class="material-cost">
                                <div class="list-group">
                                    @foreach($edit->serviceCost as  $data) 
                                        <div class="list-group-item d-flex align-items-center">
                                        <input type="hidden" name="cost_ids[]" value="{{ $data->id }}">
                                        <div class="pr-2" style="flex: 1"> 
                                                <div class="py-1">
                                                    <textarea name="cost_title[]" id="" cols="30" rows="2" class="form-control" placeholder="Enter title">{{ $data->title }}</textarea>
                                                </div> 
                                        </div>
                                            <div class="feature__trash bg-danger text-white p-2"><i class="fa fa-trash"></i></div>
                                        </div>
                    ...
                    <div class="card-body card-block">   
                        <div class="form-group pb-3">
                            ...
                            <div class="service-question">
                                <div class="list-group"> 
                                   @foreach($edit->serviceQuestion as  $data) 
                                    <div class="list-group-item d-flex align-items-center">
                                        <input type="hidden" name="question_ids[]" value="{{ $data->id }}">
                                       <div class="pr-2" style="flex: 1">
                                            <div class="py-1">
                                                <input type="text" value="{{ $data->title }}" required name="question_title[]" placeholder="Enter title" class="form-control">
                                            </div> 
                                            <div class="py-1">
                                                <input type="number" required name="question_price[]"  placeholder="Enter price"  class="form-control" value="{{ $data->price }}">
                                            </div>
                                       </div>
                                        <div class="feature__trash bg-danger text-white p-2"><i class="fa fa-trash"></i></div>
                                    </div> 
